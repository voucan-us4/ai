        ...
        const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    ...
                    ...prevmessages,
                    { role: "user", content: `Here are our last 3 messages: ${JSON.stringify(prevmessages)}. Do not respond to them. Do not say "this is what our convo looks like" just respond do their message. Here is my message: ${userMessage}` }
                ],
                temperature: 0.9,
                max_tokens: 1024,
                stream: false
